    ...
    public void onManagerConnected(int status)
    {
        switch (status)
        {
            ...
            case LoaderCallbackInterface.MARKET_ERROR:
            {
                ...
                MarketErrorMessage.setCancelable(false); // This blocks the 'BACK' btnPilihGambar
            ...
            case LoaderCallbackInterface.INCOMPATIBLE_MANAGER_VERSION:
            {
                ...
                IncomatibilityMessage.setCancelable(false); // This blocks the 'BACK' btnPilihGambar
            ...
            default:
            {
                ...
                InitFailedDialog.setCancelable(false); // This blocks the 'BACK' btnPilihGambar
    ...
    public void onPackageInstall(final int operation, final InstallCallbackInterface callback)
    {
        switch (operation)
        {
            case InstallCallbackInterface.NEW_INSTALLATION:
            {
                ...
                InstallMessage.setCancelable(false); // This blocks the 'BACK' btnPilihGambar
            ...
            case InstallCallbackInterface.INSTALLATION_PROGRESS:
            {
                ...
                WaitMessage.setCancelable(false); // This blocks the 'BACK' btnPilihGambar
